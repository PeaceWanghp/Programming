...
- (void)viewDidLoad {
    ...
    [self.model appendDarkItemWithTitle:@"KeyFrameAnimation(关键帧动画)" class:[UIViewController class]];
    [self.model appendDarkItemWithTitle:@"UIBezierPathAnimation(抛物线动画)" class:[UIViewController class]];
    [self.model appendDarkItemWithTitle:@"CAAnimationGroup(组合动画)" class:[UIViewController class]];
}
