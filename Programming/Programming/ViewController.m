...
- (void)viewDidLoad {
    ...
    [self.model appendDarkItemWithTitle:@"Property" class:NSClassFromString(@"OCPropertyController")];
    [self.model appendDarkItemWithTitle:@"Memory/RetainCount" class:NSClassFromString(@"OCMemoryController")];
    [self.model appendDarkItemWithTitle:@"Category" class:NSClassFromString(@"OCCategoryController")];
