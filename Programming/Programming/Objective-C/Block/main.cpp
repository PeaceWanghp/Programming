...
struct __Block_byref_value1_0 {
  void *__isa;
__Block_byref_value1_0 *__forwarding;
 int __flags;
 int __size;
 int value1;
};
...
struct __main_block_impl_0 {
  ...
  int value;
  __Block_byref_value1_0 *value1; // by ref
  __main_block_impl_0(void *fp, struct __main_block_desc_0 *desc, int _value, __Block_byref_value1_0 *_value1, int flags=0) : value(_value), value1(_value1->__forwarding) {
...
static void __main_block_func_0(struct __main_block_impl_0 *__cself) {
  __Block_byref_value1_0 *value1 = __cself->value1; // bound by ref
  int value = __cself->value; // bound by copy

           printf("Block %d",value);
           (value1->__forwarding->value1) = 1;
       }
static void __main_block_copy_0(struct __main_block_impl_0*dst, struct __main_block_impl_0*src) {_Block_object_assign((void*)&dst->value1, (void*)src->value1, 8/*BLOCK_FIELD_IS_BYREF*/);}

static void __main_block_dispose_0(struct __main_block_impl_0*src) {_Block_object_dispose((void*)src->value1, 8/*BLOCK_FIELD_IS_BYREF*/);}
...
int main(int argc, char * argv[]) {
    ...
    int value = 0;
       __attribute__((__blocks__(byref))) __Block_byref_value1_0 value1 = {(void*)0,(__Block_byref_value1_0 *)&value1, 0, sizeof(__Block_byref_value1_0), 0};
       void(*blk)(void) = ((void (*)())&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_0_DATA, value, (__Block_byref_value1_0 *)&value1, 570425344));
       ((void (*)(__block_impl *))((__block_impl *)blk)->FuncPtr)((__block_impl *)blk);
       printf("value1 = %d",(value1.__forwarding->value1));
       return 0;
